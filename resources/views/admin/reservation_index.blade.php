    ...
    <div class="overflow-x-auto shadow-md sm:rounded-lg px-7">
            <div class="justify-between p-3 flex border-b-2 w-full mb-6">
                <div class=""> 
                    ...
                    <p class="mt-1 text-sm font-normal text-gray-500 dark:text-gray-400">Browse a Reservation of Bebek Ayayo.</p>
                </div>
                <div>
                        ...
                        @forelse($models as $item)
                            <tr>
                                ...
                                <td>
                                 ...
                                 <span class="bg-yellow-500 text-white rounded-full px-2 py-1 text-base">Menunggu reservasi</span>
                            @elseif($item->status == 'approved')
                                : <span class="bg-green-500 text-white rounded-full px-2 py-1 text-base">Reservasi dikonfirmasi</span>
                            @elseif($item->status == 'waiting payment')
                                : <span class="bg-yellow-500 text-white rounded-full px-2 py-1 text-base">Menunggu pembayaran</span>
                            @elseif($item->status == 'canceled')
                                : <span class="bg-red-500 text-white rounded-full px-2 py-1 text-base">Reservasi dibatalkan</span>
                            @elseif($item->status == 'done')
                                : <span class="bg-green-500 text-white rounded-full px-2 py-1 text-base">Reservasi selesai</span>
                            @endif
                                </td>
                                <td>
                                    {!! Form::open([
